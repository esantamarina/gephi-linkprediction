 ...
 * @author pjmcswee
 */
public class JaccardCoefficientPanel extends PredictionPanelAbs{

    public JaccardCoefficientPanel() {
       super();
        initComponents();        
   ...
   if (graph.getModel().isDynamic()){
    ...
    private void initComponents() {
        ...
        jXHeader1.setDescription(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jXHeader1.title")); // NOI18N

        jTextField3.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jTextField3.text")); // NOI18N

        labelCant.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.labelCant.text")); // NOI18N

        jRadioButton2.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jRadioButton2.text")); // NOI18N
        ...
        jLabel5.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jLabel5.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jTextField4.text")); // NOI18N

        jXLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel1.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jXLabel1.text")); // NOI18N
        jXLabel1.setFont(jXLabel1.getFont().deriveFont(jXLabel1.getFont().getSize()-1f));
        jXLabel1.setLineWrap(true);

        jRadioButton3.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jRadioButton3.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jLabel2.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jTextField1.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jLabel1.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jTextField5.text")); // NOI18N
        ...
        jXLabel2.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jXLabel2.text")); // NOI18N
        jXLabel2.setFont(jXLabel2.getFont().deriveFont(jXLabel2.getFont().getSize()-1f));
        jXLabel2.setLineWrap(true);

        jTextField2.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jTextField2.text")); // NOI18N

        jCheckBox1.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jCheckBox1.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jLabel3.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jLabel4.text")); // NOI18N

        jRadioButton1.setText(org.openide.util.NbBundle.getMessage(JaccardCoefficientPanel.class, "JaccardCoefficientPanel.jRadioButton1.text")); // NOI18N
