 ...
 * @author pjmcswee
 */
public class CommonNeighborsPanel extends PredictionPanelAbs{

    public CommonNeighborsPanel() {    
        super();
        initComponents();        
    ...
    private void initComponents() {
        ...
        jXHeader1.setDescription(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jXHeader1.title")); // NOI18N

        labelCant.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.labelCant.text")); // NOI18N

        jXLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel1.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jXLabel1.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jTextField1.text")); // NOI18N
        ...
        jTextField2.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jTextField2.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jLabel4.text")); // NOI18N

        jTextField3.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jTextField3.text")); // NOI18N

        jTextField4.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jTextField4.text")); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jLabel5.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jTextField5.text")); // NOI18N
        ...
        jRadioButton1.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jRadioButton1.text")); // NOI18N
        ...
        jRadioButton2.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jRadioButton2.text")); // NOI18N
        ...
        jRadioButton3.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jRadioButton3.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jLabel1.text")); // NOI18N

        jXLabel2.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel2.setText("Indica el porcentaje de enlaces a ocultar para cada nodo y luego comparar con las predicciones");
        jXLabel2.setFont(jXLabel2.getFont().deriveFont(jXLabel2.getFont().getSize()-1f));
        jXLabel2.setLineWrap(true);

        jCheckBox1.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jCheckBox1.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(CommonNeighborsPanel.class, "CommonNeighborsPanel.jLabel3.text")); // NOI18N
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            ...
                            .addComponent(jLabel5))
                        .addGap(27, 27, 27))
                    .addComponent(jXLabel2, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jRadioButton1)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
