 ...
 * @author pjmcswee
 */
public class HubPromotedPanel extends PredictionPanelAbs{

    public HubPromotedPanel() {    
        super();
        initComponents();        
   ...
   if (graph.getModel().isDynamic()){
    ...
    private void initComponents() {
        ...
        jXHeader1.setDescription(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jXHeader1.title")); // NOI18N

        labelCant.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.labelCant.text")); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jLabel5.text")); // NOI18N

        jXLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel1.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jXLabel1.text")); // NOI18N
        jXLabel1.setFont(jXLabel1.getFont().deriveFont(jXLabel1.getFont().getSize()-1f));
        jXLabel1.setLineWrap(true);

        jLabel2.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jLabel2.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jTextField1.text")); // NOI18N
        ...
        jTextField5.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jTextField5.text")); // NOI18N
        ...
        jTextField2.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jTextField2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jLabel3.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jLabel4.text")); // NOI18N

        jRadioButton1.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jRadioButton1.text")); // NOI18N
        ...
        jTextField3.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jTextField3.text")); // NOI18N

        jRadioButton2.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jRadioButton2.text")); // NOI18N
        ...
        jTextField4.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jTextField4.text")); // NOI18N

        jRadioButton3.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jRadioButton3.text")); // NOI18N
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jLabel1.text")); // NOI18N

        jXLabel2.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel2.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jXLabel2.text")); // NOI18N
        jXLabel2.setFont(jXLabel2.getFont().deriveFont(jXLabel2.getFont().getSize()-1f));
        jXLabel2.setLineWrap(true);

        jCheckBox1.setText(org.openide.util.NbBundle.getMessage(HubPromotedPanel.class, "HubPromotedPanel.jCheckBox1.text")); // NOI18N
