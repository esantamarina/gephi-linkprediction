 ...
 * @author pjmcswee
 */
public class RandomPredictionPanel extends PredictionPanelAbs{

    public RandomPredictionPanel() {    
        super();
        initComponents();        
   ...
   if (graph.getModel().isDynamic()){
    ...
    private void initComponents() {
        ...
        jXHeader1.setDescription(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jXHeader1.title")); // NOI18N

        jRadioButton1.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jRadioButton1.text")); // NOI18N
        ...
        jXLabel2.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jXLabel2.text")); // NOI18N
        jXLabel2.setFont(jXLabel2.getFont().deriveFont(jXLabel2.getFont().getSize()-1f));
        jXLabel2.setLineWrap(true);

        jLabel2.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jLabel2.text")); // NOI18N

        jRadioButton2.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jRadioButton2.text")); // NOI18N
        ...
        jTextField2.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jTextField2.text")); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jLabel5.text")); // NOI18N

        jCheckBox1.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jCheckBox1.text")); // NOI18N
        ...
        jTextField4.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jTextField4.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jTextField1.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jLabel3.text")); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jLabel1.text")); // NOI18N

        jXLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel1.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jXLabel1.text")); // NOI18N
        jXLabel1.setFont(jXLabel1.getFont().deriveFont(jXLabel1.getFont().getSize()-1f));
        jXLabel1.setLineWrap(true);

        jTextField3.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jTextField3.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jLabel4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jTextField5.text")); // NOI18N
        ...
        jRadioButton3.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.jRadioButton3.text")); // NOI18N
        ...
        labelCant.setText(org.openide.util.NbBundle.getMessage(RandomPredictionPanel.class, "RandomPredictionPanel.labelCant.text")); // NOI18N
