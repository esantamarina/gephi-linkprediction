...
public class AdamicAdarUI extends PredictorAbsUI {
 
    private AdamicAdarPanel panel;
    
    @Override
    public JPanel getSettingsPanel() {
       panel = new AdamicAdarPanel();
       return panel;
    }
    ...
    public String getDisplayName() {
         return NbBundle.getMessage(getClass(), "AdamicAdarUI.name");  
    }
