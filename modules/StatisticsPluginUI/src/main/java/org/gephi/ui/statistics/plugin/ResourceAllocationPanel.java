 ...
 * @author pjmcswee
 */
public class ResourceAllocationPanel extends PredictionPanelAbs{
   ...
   if (graph.getModel().isDynamic()){
    ...
    private void initComponents() {
        ...
        jXHeader1.setDescription(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jXHeader1.description")); // NOI18N
        jXHeader1.setTitle(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jXHeader1.title")); // NOI18N

        jRadioButton1.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jRadioButton1.text")); // NOI18N
        ...
        jXLabel2.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jXLabel2.text")); // NOI18N
        jXLabel2.setFont(jXLabel2.getFont().deriveFont(jXLabel2.getFont().getSize()-1f));
        jXLabel2.setLineWrap(true);

        jLabel2.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jLabel2.text")); // NOI18N

        jRadioButton2.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jRadioButton2.text")); // NOI18N
        ...
        jTextField2.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jTextField2.text")); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jLabel5.text")); // NOI18N

        jCheckBox1.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jCheckBox1.text")); // NOI18N
        ...
        jTextField4.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jTextField4.text")); // NOI18N
        ...
        jTextField1.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jTextField1.text")); // NOI18N
        ...
        jLabel3.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jLabel3.text")); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jLabel1.text")); // NOI18N

        jXLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jXLabel1.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jXLabel1.text")); // NOI18N
        jXLabel1.setFont(jXLabel1.getFont().deriveFont(jXLabel1.getFont().getSize()-1f));
        jXLabel1.setLineWrap(true);

        jTextField3.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jTextField3.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jLabel4.text")); // NOI18N

        jTextField5.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jTextField5.text")); // NOI18N
        ...
        jRadioButton3.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.jRadioButton3.text")); // NOI18N
        ...
        labelCant.setText(org.openide.util.NbBundle.getMessage(ResourceAllocationPanel.class, "ResourceAllocationPanel.labelCant.text")); // NOI18N
