...
public class JaccardCoefficientUI extends PredictorAbsUI {

    private JaccardCoefficientPanel panel;

     
    @Override
    public JPanel getSettingsPanel() {
       panel = new JaccardCoefficientPanel();
       return panel;
    }
    ...
    public String getDisplayName() {
         return NbBundle.getMessage(getClass(), "JaccardCoefficientUI.name");  
    }
